...
Para empezar, importa FastAPI y BaseModel de pydantic, crea la instancia de la aplicación, define el modelo y luego implementa el endpoint POST.
El endpoint debe ser una función asíncrona que reciba el modelo como parámetro y retorne un diccionario con la respuesta.
'''
...
@app.post("/libros")
async def obtener_libros(libro:Libro):
    respuesta = {
        "mensaje" : f"El libro {libro.titulo} ha sido encontrado",
        "autor": libro.autor,
